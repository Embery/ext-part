    ...
    items: [
        {
            ...
            html: `
                ...
                Ссылки: 
                <a href="https://github.com/Embery/ext-part.git" target="_blank">экстовая часть</a> и 
                <a href="https://github.com/Embery/react-part" target="_blank">реактовая часть<a></p>
            `,
        },
        {
            xtype: 'mainpanel'
